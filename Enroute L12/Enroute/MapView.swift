...
struct MapView: UIViewRepresentable {
    ...
    class Coordinator : NSObject, MKMapViewDelegate {
        ...
        func mapView(_ mapView: MKMapView, viewFor annotation: MKAnnotation) -> MKAnnotationView? {
            let view = mapView.dequeueReusableAnnotationView(withIdentifier: "MapKitAnnotationView") ?? MKPinAnnotationView(annotation: annotation, reuseIdentifier: "MapKitAnnotationView")
